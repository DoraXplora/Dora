...
export const MAINNET_BETA_URL = 'https://rpc.testnet.soo.network/rpc';
export const TESTNET_URL = 'https://rpc.testnet.soo.network/rpc';
export const DEVNET_URL = 'https://rpc.devnet.soo.network/rpc';
...
export function clusterUrl(cluster: Cluster, customUrl: string): string {
  ...
  switch (cluster) {
    ...
    case Cluster.MainnetBeta:
      return (
        process.env.NEXT_PUBLIC_MAINNET_RPC_URL ?? modifyUrl(MAINNET_BETA_URL)
      );
    case Cluster.Testnet:
